...
public class GameNormalActivity extends ActionBarActivity implements View.OnClickListener {

    private Context context;
    private int postDelay = DEFAULT_DELAY;
    private GameUtils.GAME_DIFFICULT game_difficult = GameUtils.GAME_DIFFICULT.NORMAL;
    ...
    private ImageButton btnRed, btnYellow, btnBlue, btnGreen;
    ...
    private int soundRedId, soundYellowId, soundBlueId, soundGreenId;
